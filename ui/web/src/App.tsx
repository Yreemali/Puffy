...
type PaletteName = 'rose' | 'lavender' | 'mint' | 'peach'
type UserProfile = { name: string; avatar: string; theme: ThemeMode; palette: PaletteName }
const paletteColors: Record<PaletteName, string> = { rose: '#e084a9', lavender: '#8e9eea', mint: '#69c5ae', peach: '#e7a276' }
